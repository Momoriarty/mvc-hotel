                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Total transaksi terkonfirmasi:
                                <?= $total_terkonfirmasi; ?>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Total transaksi pending:
                                <?= $total_pending; ?>
                            </div>
                        </div>
                        <div class="col-auto">
